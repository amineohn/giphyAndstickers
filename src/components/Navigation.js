    ...
    <>
      <div class="pb-4">
        <ul class="flex">
          <li class="mr-3">
            <Link
              class="inline-flex rounded hover:text-gray-100 text-gray-700 hover:bg-red-400 py-1 px-3 transition duration-150 inline-flex"
              to="/"
            >
              <svg
                width="30"
          ...
          <li class="mr-3">
            <Link
              class="inline-flex rounded hover:text-gray-100 text-gray-700 hover:bg-red-400 py-1 px-3 transition duration-150"
              to="/stickers"
            >
              <svg
                width="30"
